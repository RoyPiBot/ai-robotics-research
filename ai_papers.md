...
- **機構**：Tufts 大學
- **發布時間**：2026 年 4 月
- **摘要**：Tufts 研究團隊推出神經符號 VLA 系統，結合統計模式識別與符號推理，解決傳統 VLA 對試錯學習的依賴。該系統能在動態環境中與人類協作，整合視覺感知、語言理解與行動規劃三者，標誌著機器人 AI 從感覺-反應迴圈向推理驅動執行的轉變。
- **重要性**：多模態融合與符號推理的統一框架，為實體 AI 邊界優化提供新路徑。
